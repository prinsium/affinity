...
import { pricingData } from '@/app/db/pricing';
    ...
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center my-12">
          <h1 className='text-[#333333]'>Affinity Software</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {products.map((productKey) => {
            ...
            return (
              <div
                key={productKey}
                className="group relative bg-white/10 backdrop-blur-lg rounded-3xl border-2 border-[#333333]/20 p-4 hover:bg-white/15 hover:border-[#333333]/30 transition-all duration-300"
              >
                ...
                {/* Features */}
                <div className="mb-6">
                  <h4 className="text-gray-500 font-semibold mb-3">Features</h4>
                ...
                <div className="space-y-3 border-t border-white/10 pt-4">
                  <button className="w-full text-purple-300 hover:text-[#2f2f2f] transition-colors duration-300 text-sm">
                    Upgrade from v1
                  </button>
                  <button className="w-full text-gray-400 hover:text-[#2f2f2f] transition-colors duration-300 text-sm">
                    Try now for free
                  </button>
                </div>
              </div>
