...
export default function Appsection(){
    return(
        <>
        <div className="relative m-3 md:m-8 flex flex-row rounded-2xl bg-[#ffffff] md:h-[75vh] overflow-hidden">

        <div className="relative z-20 justify-center md:justify-start flex flex-col gap-6 p-3 md:p-8 min-w-[60vw]">
        <h2 className="text-center md:text-start">Affinity Creative Bundle</h2>
        ...
        <h6 className="text-center md:text-start">Get Version 2 of Affinity Designer, Affinity Photo and Affinity Publisher <br/> on all operating systems, including iPad, macBook & desktops for one low bundle price.</h6>
        <div className="flex flex-row gap-4 justify-center md:justify-start items-start">
        ...
        <h5 className="text-center md:text-start">All Apps, All Platforms, No Subscription</h5>
        ...
        <div className="grid md:grid-cols-3 gap-8 justify-between m-3 md:m-8">
            {crd.map((item) => (
              <div key={item.id} className="rounded-2xl bg-[#ffffff] flex flex-col gap-6 items-center p-3 md:p-8">
